...
class Forehead(Organ):
    ...
    def get_mask_re(self,ksize=None):
        ...
        self._draw_convex_hull(mask,landmark_re,color=1)
...
class Makeup():
    ...
    化妆器
    '''
    def __init__(self,predictor_path="D:/PycharmProjects/AIMakeup-master/data/shape_predictor_68_face_landmarks.dat"):
        self.photo_path=[]
